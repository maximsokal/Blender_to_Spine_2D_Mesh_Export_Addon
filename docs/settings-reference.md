...
**0.152.0**. Fresh-Scene defaults are listed below. The current Scene settings schema is
**8**.
...
`spine2d_texture_size` remains the same persisted Scene property in 0.152.0; only its visual
