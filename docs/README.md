...
- Candidate 0.55.9 corrects the pure setup-depth fixture so it uses profile-owned Z-group indices rather than assuming zero-based indices; production projection and rig behavior are unchanged.
