...
- Candidate 0.55.8 corrects only the typed pure-test fixture and release wording used by the 0.55.7 validation gate; production projection and rig behavior are unchanged.
