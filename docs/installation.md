...
5. Select `blender_to_spine2d_mesh_exporter-0.55.18.zip`.
...
```text
 dist/blender_to_spine2d_mesh_exporter-0.55.18.zip
```
...
```text
blender --command extension validate dist/blender_to_spine2d_mesh_exporter-0.55.18.zip
```
