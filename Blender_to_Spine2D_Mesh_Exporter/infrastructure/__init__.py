...
from .durable_atomic_transaction import (
...
# Existing callers retain the established public names while production is routed
# through the crash-durable implementation. The historical atomic_files module
# remains importable for compatibility and architecture tests.
