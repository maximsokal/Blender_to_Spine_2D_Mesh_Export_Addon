"""Current architectural contracts for Depth Camera Projection parallax reserve."""
...
RENDER_PROXY = PACKAGE / "blender_adapter" / "depth_camera_projection_render_proxy.py"
...
FINALIZATION = PACKAGE / "blender_adapter" / "a1_depth_projection_finalization.py"
...
def test_current_manifest_and_scene_schema_match_depth_contract() -> None:
