"""Source contracts for the exact Spine 4.1 scale-response runtime probe."""
...
PROBE = ROOT / "tools" / "spine41_scale_response_probe.mjs"
...
def test_probe_rejects_the_superseded_local_and_layer_driver_policy() -> None:
    source = _source()
