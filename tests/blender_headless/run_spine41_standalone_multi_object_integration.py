...
This worker deliberately exercises the production A1 multi-object output service. It does
not construct or rewrite Spine JSON manually and never enters connected composition.
"""
...
def _assert_standalone_document(document: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "slots": len(slots),
        "ik": len(document["ik"]),
        "transform": len(document["transform"]),
